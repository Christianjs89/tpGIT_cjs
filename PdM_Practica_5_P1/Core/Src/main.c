...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define RECEIVE_SIZE 4 // cantidad de caracteres a recibir
/* USER CODE END PD */
...
/* Private variables ---------------------------------------------------------*/
//UART_HandleTypeDef huart2; // no utilizar
...
//static void MX_USART2_UART_Init(void); // no utilizar
/* USER CODE BEGIN PFP */
...
{
  /* USER CODE BEGIN 1 */
  bool_t uartState; // indica el estado de la inicializacion uart
  /* USER CODE END 1 */
